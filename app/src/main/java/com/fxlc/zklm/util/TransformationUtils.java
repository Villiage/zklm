...
public final class TransformationUtils {
   ...
   */
  public static Bitmap fitCenter( @NonNull Bitmap inBitmap, int width,
      int height) {
    if (inBitmap.getWidth() == width && inBitmap.getHeight() == height) {
    ...
    Bitmap toReuse = Bitmap.createBitmap(targetWidth, targetHeight, config);
   ...
   */
  public static Bitmap centerInside( @NonNull Bitmap inBitmap, int width,
                                 int height) {
    if (inBitmap.getWidth() <= width && inBitmap.getHeight() <= height) {
      if (Log.isLoggable(TAG, Log.VERBOSE)) {
   ...
   */
  public static Bitmap rotateImageExif( @NonNull Bitmap inBitmap,
      int exifOrientation) {
   ...
   * @return The resized Bitmap (will be recycled if recycled is not null).
   */
  public static Bitmap circleCrop( @NonNull Bitmap inBitmap,
  ...
  private static Bitmap getAlphaSafeBitmap(
    ...
    Bitmap argbBitmap = Bitmap.createBitmap(maybeAlphaSafe.getWidth(), maybeAlphaSafe.getHeight(),
   ...
   */
  public static Bitmap roundedCorners( @NonNull Bitmap inBitmap,
